function get_packets(dev_pseudonym, date_start, date_end) {
  ...
  $.ajax( "https://api.beta.ttnmon.meis.space/api/packet/?dev_pseudonym=" + dev_pseudonym + "&date_start=" + string_start + "&date_end=" + string_end + "&timezone_offset=" + get_timeOffset(), {"dataType": 'json', "timeout": 20000})
  .done( function( data ) {
    if (data["error"] != 0) {
