...
function load_gateway(dev_pseudonym, gtw_id, date_start, date_end) {
  ...
  $.ajax( "https://api.ttnmon.meis.space/api/gateway/device/?dev_pseudonym=" + dev_pseudonym + "&date_start=" + string_start + "&date_end=" + string_end + "&gtw_id=" + gtw_id, {"dataType": 'json', "timeout": 3000})
    .done(function(data) {
      var channel = [];
      var snr = [];
      var rssi = [];
